...
| ARC-05 | Thread-safety model inconsistent | major | mixed | 0.5.x (D-3) | planned (ferrompi-0.5.x-hardening) |
...
| BLT-27 | Dead `ferrompi_init`; module-wide `allow(dead_code)` | 25 | 0.5.x† | planned (ferrompi-0.5.x-hardening) |
...
| INF-09 | MPI-4 probes turn regressions into silent passes | major | reading | 0.5.x | planned (ferrompi-0.5.x-hardening) |
...
| INF-12 | Public APIs untested; examples never run | minor | reading | 0.5.x | planned (ferrompi-0.5.x-hardening) |
